...
public class TestChargingSessionController {
    ...
    @Test
    public void testCreateChargingSessionBadRequest() throws Exception {

        ChargingSessionRequest chargingRequest=new ChargingSessionRequest();
        chargingRequest.setStationId(null);
        mockMvc.perform(post("/chargingSessions").
                contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
                .content(asJsonString(chargingRequest)))
    ...
    public void testUpdateChargingSessionByIdWrongInput() throws Exception {

        ChargingSessionResponse chargingSessionResponse=new ChargingSessionResponse();
        String input="hello";
        mockMvc.perform(put("/chargingSessions/"+input).
                contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.error").value("Invalid UUID string: "+input));
